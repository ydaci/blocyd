...
<g>
  <text x="0" y="100">La Liga</text>
</g>
</svg>
<p style="color:blue"> Mon analyse<i class="fa fa-chevron-up"></i> </p>
<ul style="display:none;color:blue">
Cette année, l'Atlético de Madrid domine outrageusement le championnat.
Les colchoneros devraient se diriger vers un titre facile.
Le Real Madrid devrait en être le dauphin.
</ul>
</body>
	<div>
